...
private:
    ...
    struct Keyboard{
        ...
        Keyboard(const std::unordered_map<int, KeyState> &monitoredKeys, int positiveHorizontalKey, int negativeHorizontalKey, int positiveVerticalKey, int negativeVerticalKey):
